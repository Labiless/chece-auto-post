...
(async () => {
    ...
    const collectionEditionNumber = await GoogleSerivce.getDailyTrack().then(el => el[3]);
    const image1Base64 = await CanvasService.createCoverImage(templateImageUrl1, collectionEditionNumber);
